 ...
 */
final class Version20200916100436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD products LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD price DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP products, DROP price');
    }
}
